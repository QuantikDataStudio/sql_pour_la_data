...
(member_id varchar(60) not null,
 ...
 CONSTRAINT id_pk_member primary key (member_id)
);
...
FOREIGN KEY (rating_giver_id) REFERENCES members (member_id) ON DELETE CASCADE,
FOREIGN KEY (rating_receiver_id) REFERENCES members (member_id) ON DELETE CASCADE
);
...
FOREIGN KEY (member_car_id) REFERENCES member_car (member_car_id) ON DELETE CASCADE,
FOREIGN KEY (starting_city_id) REFERENCES cities (city_id) ON DELETE CASCADE,
FOREIGN KEY (destination_city_id) REFERENCES cities (city_id) ON DELETE CASCADE,
FOREIGN KEY (luggage_id) REFERENCES luggage_types (luggage_type_id) ON DELETE CASCADE
);
